...
<form>
     ...
     <input  className="op" type="radio" name="radio" value="option1" />
        ...
        <label className='out'>Outro:<br></br><input className='tri' type="text" /></label><br></br>

      <label>Há quanto tempo está com Dor/Incomodo?:
      <br></br><input className='dor'type='text'></input><br></br>
      </label>
      <label>Qual a Intencidade da Dor?
      <br></br><input  type="radio" name="myradio" value="option1" />
          0-4
        </label>
        <label>
